...
df <- read.csv("germination_timetoevent_Betula_pubescens.csv")
...
saveRDS(GRlist,file="output/rds/GR_mod1_Betula_pubescens.rds")
...
# GRlist <- readRDS("output/rds/GR_mod1_Betula_pubescens.rds")
...
write.csv(Out_w, "output/csv/Thresholds_models_Betula_pubescens.csv", row.names = FALSE)
write.csv(Out, "output/csv/results_models_Betula_pubescens.csv", row.names = FALSE)
write.csv(Predictions, "output/csv/predictions_Betula_pubescens.csv", row.names = FALSE)
...
save(plot, file = "output/rda/plot_betula_pub.rda")
